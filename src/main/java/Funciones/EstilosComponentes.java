...
import CustomComponents.ModelColor;
import CustomComponents.PanelGradient;
...
public class EstilosComponentes {
    ...
    public void setStyleTableDefault(JTable tb, JScrollPane scroll, Color headerColor, Color viewportBackground, Color scrollColor, Color tbBackground, Color fontColor) {
        ...
        tb.setFont(new Font("Roboto", Font.PLAIN, 16));
        tb.setForeground(fontColor);
        tb.setRowHeight(30);
        tb.setEnabled(false);
        scroll.setVerticalScrollBar(new ScrollBarCustom(viewportBackground, scrollColor));
        ...
        for (int i = 0; i < tb.getColumnCount(); i++) {
            tb.getColumnModel().getColumn(i).setCellRenderer(tcr);
        }
    }
}
