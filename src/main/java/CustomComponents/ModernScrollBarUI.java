...
public class ModernScrollBarUI extends BasicScrollBarUI {
    ...
    private Color backgroundPortColor, scrollColor;

    public ModernScrollBarUI(Color color, Color scroll) {
        backgroundPortColor = color;
        scrollColor = scroll;
    }
    ...
    protected void paintTrack(Graphics grphcs, JComponent jc, Rectangle rctngl) {
        ...
        g2.setColor(backgroundPortColor);
